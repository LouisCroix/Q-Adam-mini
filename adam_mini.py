        ...
        for group in self.param_groups:
            ...
            for p in group["params"]:
                ...
                if any(adam_block_name in name for adam_block_name in
                    ...
                    if "10.self_attn.k_proj.weight" in name:
                        wandb.log({
                            "10.self_attn.k_proj.weight-weight_norm": p.norm(),
                            "10.self_attn.k_proj.weight-grad_norm": grad.norm(),
                            "10.self_attn.k_proj.weight-m_norm": state["m"].norm(),
                            "10.self_attn.k_proj.weight-v_norm": state["vmean"].norm(),
                            },
                            commit=False,
                        )
                    ...
                    if "10.mlp.down_proj.weight" in name:
                        wandb.log({
                            "10.mlp.down_proj.weight-weight_norm": p.norm(),
                            "10.mlp.down_proj.weight-grad_norm": grad.norm(),
                            "10.mlp.down_proj.weight-m_norm": state["m"].norm(),
                            "10.mlp.down_proj.weight-v_norm": state["vmean"].norm(),
                            },
                            commit=False,
                        )
                    ...
                    if "embed_tokens.weight" in name:
                        wandb.log({
                            "embed_tokens-weight_norm": p.norm(),
                            "embed_tokens-grad_norm": grad.norm(),
                            "embed_tokens-m_norm": state["m"].norm(),
                            "embed_tokens-v_norm": state["vmean"].norm(),
                            },
                            commit=False,
                        )
