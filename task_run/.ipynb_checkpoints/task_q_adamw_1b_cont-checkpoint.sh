...
torchrun --standalone --nproc_per_node 1 my_run_pretrain_halfpre.py \
    ...
    --continue_from /mntcephfs/data/ruoyusun/hanyizhou/q-adam-mini-checkpoints/model_Q-AdamW-1B_3e-4_256_halfpre_37500 \
    --lr 3e-4 \
    --batch_size 4 \
    ...
    --optimizer adamw8bit \
    --project '1B' \
    --name Q-AdamW-1B_3e-4_256_halfpre > Q_AdamW_1B_3e-4_256_halfpre_cont2
